    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 mb-5 px-4">
            <div class=" bg-white rounded shadow p-4 ">
                ...
                <h5>Address</h5>
                <a href="https://maps.app.goo.gl/4hRFGr8ATx2iMM4R8" target="_blank"
                ...
                <a href="mailto:WlTzA@example.com" class="D-inline-block text-decoration-none text-dark"> <i
                            class="bi bi-envelope-fill"></i> ask.tharusha@gmail.com</a>
                <h5>Find us</h5>
